...
export default function Navbar(props) 
{
  ...
  return (
    <header className="header">
        <span onClick={() => navigate("/")} className="header-image-link"><img 
            src={logo}
        ...
        <div className="header-links">
          <ul className="header-navlist">
            <li><span onClick={() => navigate("/")} className={`header-link ${props.currPage === "Home"?"nav-selected":"" }`}>Home</span></li>
            <li className="header-dropdown">
              <span onClick={() => navigate("/products")} className={`header-link ${props.currPage === "Products"?"nav-selected":"" }`}>Products</span>
              <div className="header-link-dropdown">
                <span onClick={() => navigate("/products")}>View All Products</span>
                <span onClick={() => navigate("/products/add")}>Add Products</span>
              </div>
            </li>
            <li><span onClick={() => navigate("/")} className={`header-link ${props.currPage === "Categories"?"nav-selected":"" }`}>Categories</span></li>
            <li><span onClick={() => navigate("/")} className={`header-link ${props.currPage === "News"?"nav-selected":"" }`}>News</span></li>
            <li><span onClick={() => navigate("/about")} className={`header-link ${props.currPage === "About"?"nav-selected":"" }`}>About</span></li>
            <li><span onClick={() => navigate("/contactus")} className={`header-link ${props.currPage === "Contact Us"?"nav-selected":"" }`}>Contact Us</span></li>
          </ul>
